...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.maxpool = nn.AvgPool2d(6)  # 6 is kernel_size and default stride is equal to kernel_size
    ...
    def forward(self, x):
        ...
        out = self.layer3(out)
        out = self.layer4(out)
        # out = F.avg_pool2d(out, 6)  # 4 vs 7 vs 6
...
def test():
    ...
    # net = net.cuda()
    summary(net, (3, 96, 96), device='cpu')  # default device is cuda
